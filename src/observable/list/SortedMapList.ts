...
import {sortedIndex} from "./common";
...
export class SortedMapList<K,V> extends BaseObservableList<V> {
    ...
    private _sortedPairs: Element<K,V>[] | null = null;
    private _mapSubscription: (() => void) | null = null;
...
export function tests() {
    return {
        ...
        test_initial_values(assert) {
            ...
            list.subscribe(defaultObserverWith({})); //needed to populate iterator
